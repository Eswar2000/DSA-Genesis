"""
Problem Statement:
Given a string, find out the length of longest palindromic subsequence possible.
"""
...
if __name__ == '__main__':
    ...
    palindrome_length = lps(s)
    print(f"Longest palindromic subsequence length of string {s} is {palindrome_length}")